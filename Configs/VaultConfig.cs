...
public class VaultConfig
{
    ...
    public VaultConfig(IConfiguration configuration)
    {
        ...
        Console.WriteLine("Vault token successfully loaded from file.");
        ...
        Console.WriteLine("Vault client initialized using provided token.");
    }
    ...
    public async Task<string> GetSecret(string mountPoint, string secretPath, string key)
    {
        try
        {
            ...
            Console.WriteLine($"Successfully retrieved secret key '{key}' from '{mountPoint}/{secretPath}'.");
